...
const redPacketRainImage = require("./images/red-packet-rain.png");
const redPacketRainOpenImage = require("./images/red-packet-rain-open.png");
...
Component({
  ...
  ready: function () {
    ...
    this.cancelCustomAnimationFrame(animation)
     ...
     this.cultdown()
      ...
      this.data.windowWidth = windowWidth || this.data.windowWidth
      this.data.windowHeight = windowHeight || this.data.windowHeight
  },
  detached: function () {
  ...
  methods: {
    ...
    initRain: function () {
        ...
        this.redEnvelopeImg = redPacketRainImage
        this.openEnvelopeImg = redPacketRainOpenImage
        // 初始化红包雨
        this.initRainDrops()
        // 音效
        this.audioOfClick()
